...
Функция ПечатьЗакрытияПланаРабот(МассивОбъектов, ОбъектыПечати, ИмяМакета) Экспорт
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ПланРаботТиражный.ПФ_MXL_ЗакрытиеПланаРаботТиражный");
...
Функция ПечатьПланаРабот(МассивОбъектов, ОбъектыПечати, ИмяМакета = "ПланРабот") Экспорт
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ПланРаботТиражный.ПФ_MXL_ПланРаботТиражный");
