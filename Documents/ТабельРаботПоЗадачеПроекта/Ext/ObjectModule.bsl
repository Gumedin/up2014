...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	тзРВ.Свернуть("ТарифнаяСтавка,Подразделение,Должность,ФизическоеЛицо", "Количество");
	ИтогиПоТарифС 	= Новый Соответствие;
	ИтогиПоСотрудникам	= Новый ТаблицаЗначений;
	ИтогиПоСотрудникам.Колонки.Добавить("Подразделение");
	ИтогиПоСотрудникам.Колонки.Добавить("Сотрудник");
	ИтогиПоСотрудникам.Колонки.Добавить("ТарифнаяСтавка");
	ИтогиПоСотрудникам.Колонки.Добавить("Должность");
	ИтогиПоСотрудникам.Колонки.Добавить("Сумма");
	...
	Для Каждого СтрРВ ИЗ тзРВ Цикл
		...
		стр = ИтогиПоСотрудникам.Добавить();
		стр.Подразделение =  СтрРВ.Подразделение;
		стр.Сотрудник = СтрРВ.ФизическоеЛицо;
		стр.ТарифнаяСтавка = СтрРВ.ТарифнаяСтавка;
		стр.Сумма = Цена * СтрРВ.Количество;
	...
	ИтогиПоТарифнымСтавкам = ИтогиПоСотрудникам.СкопироватьКолонки();
	ИтогиПоТарифнымСтавкам.Свернуть("ТарифнаяСтавка,Должность", "Сумма");
	Для Каждого СтрРВ ИЗ ИтогиПоТарифнымСтавкам Цикл
		...
		Движение.ТипСуммы 		= 1;
		Движение.Сумма	 		= СтрРВ.Сумма;
		ИтСумма 				= ИтСумма  + СтрРВ.Сумма;
	КонецЦикла;
	...
	ИтогиПоСотрудникам.Свернуть("Подразделение,Сотрудник", "Сумма");
	// в подразделения сотрудников
	Для Каждого Эл ИЗ ИтогиПоСотрудникам Цикл
