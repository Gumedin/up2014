...
//	
//	мПлановРабот = МассивПлановРаботПоПроектМенеджеру( ПроектМенеджер, ПериодРегистрации );
...
//		|ГДЕ
//		|	ПланРаботФронтРабот.Ссылка.ЗадачаПроекта.ПроектМенеджер = &ПроектМенджер
//		|	И ПланРаботФронтРабот.Месяц = &ПериодРегистрации
//		|
//		|СГРУППИРОВАТЬ ПО
//		|	ПланРаботФронтРабот.Ссылка";
