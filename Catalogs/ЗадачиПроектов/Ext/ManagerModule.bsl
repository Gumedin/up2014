Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "СтруктураРабот") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			КоллекцияПечатныхФорм,
			"СтруктураРабот",
...
Функция ПроверкаСтатусаЗадач(Объект) Экспорт
	Сообщить("Проверка:" + Объект.Владелец + "-" + Объект);
	...
	Для Каждого график Из ГрафикРеализации Цикл
		...
		Если сумма <> график.СуммаПлан Тогда 
