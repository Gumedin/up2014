...
Процедура ДанныеФинансы(Данные, Год)
	...
	Для Каждого строка из Результат Цикл 
		Обеспечено = строка["Обеспечено"] + Обеспечено;
		Гарантия = строка["Гарантия"] + Гарантия;
		Прогноз = строка["Прогноз"] + Прогноз;
	...
	Данные.Вставить("Доходы", Результат);
...
Функция СтатистикаФинансы(КодСтаницы, Год) Экспорт
	...
	Попытка
		...
		//ДОХОДЫ
		Категории = СформироватьJSONизТЗ(Данные["Доходы"], "Период");
		...
		серия.Вставить("data", СформироватьJSONизТЗ(Данные["Доходы"], "Обеспечено"));
		м.Добавить(СформироватьJSONизСтруктура(серия, Истина));
		
		серия.Вставить("name", "'Гарантия'");
		серия.Вставить("data", СформироватьJSONизТЗ(Данные["Доходы"], "Гарантия"));
		м.Добавить(СформироватьJSONизСтруктура(серия, Истина));
		
		серия.Вставить("name", "'Прогноз'");
		серия.Вставить("data", СформироватьJSONизТЗ(Данные["Доходы"], "Прогноз"));
		м.Добавить(СформироватьJSONизСтруктура(серия, Истина));
